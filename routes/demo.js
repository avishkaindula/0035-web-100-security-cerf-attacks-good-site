...
router.get("/transaction", function (req, res) {
  ...
  // This is how we generate a csrf token.
  // This method is provided by the csurf package.
  res.render("transaction", { csrfToken: csrfToken });
  // This is how we add the csrf Token to the transactions ejs template
  // which contains the post transaction form.
});
